    ...
    if ($("#clock").length) {
        $('#clock').countdown('2025/03/29', function(event) {
            var $this = $(this).html(event.strftime('' +
                '<div class="box"><div class="date">%D</div> <span>Días</span> </div>' +
                '<div class="box"><div class="date">%H</div> <span>Horas</span> </div>' +
                '<div class="box"><div class="date">%M</div> <span>Minutos</span> </div>' +
                '<div class="box"><div class="date">%S</div> <span>Segundos</span> </div>'));
        });
    }
